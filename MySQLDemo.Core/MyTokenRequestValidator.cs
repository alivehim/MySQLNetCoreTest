...
{
    public class MyTokenRequestValidator : ITokenRequestValidator
    {
        ...
        {
            var details = new MyTokenRequestValidationLog(_validatedRequest);
        ...
        {
            return _events.RaiseAsync(new UserLoginSuccessEvent(userName, subjectId, clientId));
        }
